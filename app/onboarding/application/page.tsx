...
export default async function ApplicationPage({ searchParams }: { searchParams: Promise<{ token?: string }> }) {
  ...
  const initial: ApplicationData = {
    ...
    emergency_name: appRow?.emergency_name ?? '',
    emergency_relationship: appRow?.emergency_relationship ?? '',
    emergency_phone: appRow?.emergency_phone ?? '',
    reference1_name: appRow?.reference1_name ?? '',
    reference1_relationship: appRow?.reference1_relationship ?? '',
    reference1_contact: appRow?.reference1_contact ?? '',
    reference2_name: appRow?.reference2_name ?? '',
    reference2_relationship: appRow?.reference2_relationship ?? '',
    reference2_contact: appRow?.reference2_contact ?? '',
