...
export default function UpdatePasswordPage() {
  ...
  const inp: React.CSSProperties = { width:'100%', padding:'10px 14px', borderRadius:8, border:'1.5px solid #D1D9E0', fontSize:14, outline:'none', fontFamily:'inherit', background:'#fff', boxSizing:'border-box' }
  const lbl: React.CSSProperties = { fontSize:13, fontWeight:600, color:'#4A6070', display:'block', marginBottom:6 }

  return (
    <div style={{ minHeight:'100vh', background:'linear-gradient(135deg,#1A2E44 0%,#0E4A4A 100%)', display:'flex', alignItems:'center', justifyContent:'center', padding:20 }}>
      <div style={{ width:'100%', maxWidth:420 }}>
        <div style={{ textAlign:'center', marginBottom:28 }}>
          <div style={{ width:52, height:52, borderRadius:14, background:'linear-gradient(135deg,#0E7C7B,#2A9D8F)', display:'flex', alignItems:'center', justifyContent:'center', margin:'0 auto 14px', fontSize:24 }}>🔑</div>
          <h1 style={{ color:'#fff', fontSize:22, fontWeight:800, margin:0 }}>Set New Password</h1>
          <p style={{ color:'rgba(255,255,255,0.6)', fontSize:13, marginTop:6 }}>Vitalis Healthcare · Staff Portal</p>
        </div>
