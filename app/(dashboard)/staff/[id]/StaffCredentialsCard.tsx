...
// Interactive credentials card for the caregiver profile page.
// Allows back-office/admin/supervisor to view document history per credential.
              ...
              return (
                <div key={c.id} style={{ padding: '10px 12px', borderRadius: 8, border: `1px solid ${col}40`, borderLeft: `3px solid ${col}`, marginBottom: 8 }}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    {c.document_url && (
                      <button
                        onClick={() => setDocViewer({ credId: c.id, credName: c.credential_type?.name || 'Credential' })}
